...
t_data = r'data/images/'
l_data = r'data/masks/'
test_image = 'test.jpg'
test_label = 'test_mask.gif'
...
data_transform_rgb = torchvision.transforms.Compose([
    torchvision.transforms.Resize((128, 128)),
    torchvision.transforms.ToTensor(),
    torchvision.transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5])
])
data_transform_gray = torchvision.transforms.Compose([
    torchvision.transforms.Resize((128, 128)),
    torchvision.transforms.ToTensor(),
...
for i in range(epoch):
    ...
    s_tb = data_transform_rgb(im_tb)
    s_label = data_transform_gray(im_label)
